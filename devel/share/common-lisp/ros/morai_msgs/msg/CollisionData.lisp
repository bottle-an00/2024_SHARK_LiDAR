...
(cl:defclass <CollisionData> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (collision_objecta
    :reader collision_objecta
    :initarg :collision_objecta
    :type (cl:vector morai_msgs-msg:ObjectStatus)
   :initform (cl:make-array 0 :element-type 'morai_msgs-msg:ObjectStatus :initial-element (cl:make-instance 'morai_msgs-msg:ObjectStatus))))
)
...
(cl:ensure-generic-function 'collision_objecta-val :lambda-list '(m))
(cl:defmethod collision_objecta-val ((m <CollisionData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader morai_msgs-msg:collision_objecta-val is deprecated.  Use morai_msgs-msg:collision_objecta instead.")
  (collision_objecta m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <CollisionData>) ostream)
  ...
  (cl:let ((__ros_arr_len (cl:length (cl:slot-value msg 'collision_objecta))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_arr_len) ostream))
  (cl:map cl:nil #'(cl:lambda (ele) (roslisp-msg-protocol:serialize ele ostream))
   (cl:slot-value msg 'collision_objecta))
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <CollisionData>) istream)
  ...
  (cl:let ((__ros_arr_len 0))
    ...
    (cl:setf (cl:ldb (cl:byte 8 16) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 24) __ros_arr_len) (cl:read-byte istream))
  (cl:setf (cl:slot-value msg 'collision_objecta) (cl:make-array __ros_arr_len))
  (cl:let ((vals (cl:slot-value msg 'collision_objecta)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:aref vals i) (cl:make-instance 'morai_msgs-msg:ObjectStatus))
  (roslisp-msg-protocol:deserialize (cl:aref vals i) istream))))
  msg
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<CollisionData>)))
  ...
  "94c37a3c4595c02a86c6b60d2df629c6")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'CollisionData)))
  "Returns md5sum for a message object of type 'CollisionData"
  "94c37a3c4595c02a86c6b60d2df629c6")
...
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <CollisionData>))
  (cl:+ 0
     ...
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'collision_objecta) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ (roslisp-msg-protocol:serialization-length ele))))
))
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <CollisionData>))
  ...
  (cl:list 'CollisionData
    ...
    (cl:cons ':collision_objecta (collision_objecta msg))
))
