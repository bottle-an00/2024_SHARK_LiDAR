...
class CollisionData {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('collision_objecta')) {
        this.collision_objecta = initObj.collision_objecta
      }
      else {
        this.collision_objecta = [];
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [collision_objecta]
    // Serialize the length for message field [collision_objecta]
    bufferOffset = _serializer.uint32(obj.collision_objecta.length, buffer, bufferOffset);
    obj.collision_objecta.forEach((val) => {
      bufferOffset = ObjectStatus.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [collision_objecta]
    // Deserialize array length for message field [collision_objecta]
    len = _deserializer.uint32(buffer, bufferOffset);
    data.collision_objecta = new Array(len);
    for (let i = 0; i < len; ++i) {
      data.collision_objecta[i] = ObjectStatus.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    object.collision_objecta.forEach((val) => {
      length += ObjectStatus.getMessageSize(val);
    });
    return length + 32;
  }
  ...
  static md5sum() {
    ...
    return '94c37a3c4595c02a86c6b60d2df629c6';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.collision_objecta !== undefined) {
      resolved.collision_objecta = new Array(msg.collision_objecta.length);
      for (let i = 0; i < resolved.collision_objecta.length; ++i) {
        resolved.collision_objecta[i] = ObjectStatus.Resolve(msg.collision_objecta[i]);
      }
    }
    else {
      resolved.collision_objecta = []
    }
