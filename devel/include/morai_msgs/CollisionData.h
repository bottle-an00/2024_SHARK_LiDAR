...
struct CollisionData_
{
  ...
  _collision_object_type collision_object;
   ...
   typedef std::vector< ::morai_msgs::ObjectStatus_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::morai_msgs::ObjectStatus_<ContainerAllocator> >> _collision_objecta_type;
  _collision_objecta_type collision_objecta;
...
bool operator==(const ::morai_msgs::CollisionData_<ContainerAllocator1> & lhs, const ::morai_msgs::CollisionData_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    ...
    lhs.collision_objecta == rhs.collision_objecta;
}
...
struct MD5Sum< ::morai_msgs::CollisionData_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x94c37a3c4595c02aULL;
  static const uint64_t static_value2 = 0x86c6b60d2df629c6ULL;
};
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::morai_msgs::CollisionData_<ContainerAllocator> >
  {
    template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
    {
      ...
      stream.next(m.collision_objecta);
    }
